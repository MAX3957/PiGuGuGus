"use strict";
const _i = ['Phigros 1.0 模拟器', [1, 0, 0], 1611795955, 1634971621];
...
function qwqdraw1(now) {
	...
	for (const i of clickEvents1) { //绘制打击特效1
		...
		ctxos.globalAlpha = 1;
		ctxos.setTransform(noteScale * 14, 0, 0, noteScale * 14, i.offsetX, i.offsetY); //缩放
	...
	if (stat.combo > 2) {
		...
		ctxos.font = `${lineScale * 0.53}px Mina`;
