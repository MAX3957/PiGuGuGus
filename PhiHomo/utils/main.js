...
(function() {
	...
	const w = `作者：<a style="text-decoration:underline"target="_blank"href="//space.bilibili.com/274753872">${d}</a><br>修改者：<a style="text-decoration:underline"target="_blank" href="//space.bilibili.com/1136182692">PigeonB</a></a><br><br>`;	if (!location.search) setInterval(Function.constructor(atob("ZGVidWdnZXI=")));
