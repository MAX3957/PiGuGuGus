"use strict";
const _i = ['Phigros 模拟器', [114, 514, 1919810], 1611795955, 1634971621];
...
function qwqdraw1(now) {
	...
	if (!qwq[0]) ctxos.drawImage(res["Pause"], lineScale * 0.6, lineScale * 0.7, lineScale * 2.7, lineScale * 1);
	if (stat.combo > 2) {
		ctxos.textAlign = "center";
		...
		ctxos.fillText(autoplay.checked ? "COMOH" : "COMBO", wlen, lineScale * 2.05);
	}
	//绘制歌名和等级
	ctxos.globalAlpha = 1;
