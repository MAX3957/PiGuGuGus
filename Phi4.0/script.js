"use strict";
const _i = ['Phigros 模拟器', [4, 1, 0], 1611795955, 1634971621];
...
function loop() {
	...
	//Copyright
	ctx.font = `${lineScale * 0.4}px Minecraft Regular`;
	ctx.fillStyle = "#ccc";
	ctx.globalAlpha = 0.8;
	ctx.textAlign = "right";
...
function qwqdraw1(now) {
	...
	if (qwqIn.second >= 3 && qwqOut.second == 0) {
		if (showPoint.checked) { //绘制定位点
			ctxos.font = `${lineScale}px Minecraft Regular`;
	...
	if (qwqIn.second < 3) {
		...
		ctxos.font = `${lineScale * 1.1}px Minecraft Regular`;
		ctxos.fillText(inputName.value || inputName.placeholder, wlen, hlen * 0.75);
		//曲绘和谱师
		ctxos.textBaseline = "top";
		ctxos.font = `${lineScale * 0.55}px Minecraft Regular`;
	...
	ctxos.textBaseline = "alphabetic";
	ctxos.font = `${lineScale * 0.95}px Minecraft Regular`;
	ctxos.textAlign = "right";
	ctxos.font = `${lineScale * 0.7}px Minecraft Regular`;
	ctxos.fillText(stat.accStr, canvasos.width - lineScale * 0.75, canvasos.height - lineScale * 1.66);
	ctxos.font = `${lineScale * 0.95}px Minecraft Regular`;
	...
	if (stat.combo > 2) {
		ctxos.textAlign = "center";
		ctxos.font = `${lineScale * 1}px Minecraft Regular`;
		...
		ctxos.font = `${lineScale * 0.5}px Minecraft Regular`;
	...
	ctxos.textBaseline = "alphabetic";
	ctxos.textAlign = "right";
	ctxos.font = `${lineScale * 0.63}px Minecraft Regular`;
	...
	if (qwq[0]) {
		...
		ctxos.font = `${lineScale * 0.4}px Minecraft Regular`;
		ctxos.textAlign = "left";
